...
const Footer = () => {
    return (
        <footer className="text-xs px-2 md:px-6 pt-6 pb-12 w-full bg-gray-200 dark:bg-gray-900 text-gray-500 dark:text-gray-400">
            <div className="item-dark-enabled px-2 py-6 md:p-6 rounded-lg grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="col-span-1 md:col-span-4">
                    {/* <div className="secondary-dark-enabled rounded-lg px-2 md:px-6 py-6">
                        <input id="email" type="email" className="w-full bg-transparent text-xl focus:outline-none" placeholder="Enter e-mail" />
                        <div className="flex items-center mt-4 justify-between gap-6">
                            <span>
                                Join our newsletter to get notified about new projects and opportunities.
                            </span>

                            <Button text={"Subscribe"} />
                        </div>
                    </div> */}
                    <div className="rounded-lg px-2 py-6 mt-6">
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                            <div className="col-span-1 flex-col flex mb-4 lg:mb-0">

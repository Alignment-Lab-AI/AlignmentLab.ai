            ...
            <div className="mx-2 md:mx-6 py-6">
                ...
                <div className='container mx-auto'>
                    ...
                    <p className='text-lg md:text-xl lg:text-2xl leading-loose'>
                        ...
                        With over 100+ leading global companies deploying our datasets, infrastructure, and models at scale we are among the leading AI research labs in the world.
                    </p>
                </div>
            </div>
            <div className="mx-2 md:mx-6 py-6">

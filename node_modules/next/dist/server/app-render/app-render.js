...
async function renderToHTMLOrFlightImpl(req, res, pagePath, query, renderOpts, baseCtx) {
   ...
   */ const params = renderOpts.params ?? {};
    ...
    const renderResult = new _renderresult.default(await renderToStream({
        ...
        waitUntil: staticGenerationStore.pendingRevalidates ? Promise.all(staticGenerationStore.pendingRevalidates) : undefined
    });
